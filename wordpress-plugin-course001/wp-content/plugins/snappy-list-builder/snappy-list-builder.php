...
Description: The ultimate email list building plugin for Wordpress. Capture new subscribers. Reward subscribers with a custom download upon
opt-in. Build unlimited lists. Import and export subscribers easily with .csv
Version: 1.0
Author: Michiel van Tienhoven
Author URI: https://www.facebook.com/michiel.vantienhoven
License: GPL2
...
/*
    ...
    8. ADMIN PAGES
        8.1 - dashboard - slb_dashboard_admin_page()
        8.2 - import subscribers - slb_import_admin_page()
        8.3 - plugin options - slb_options_admin_page()
...
// 3.2.2
// hint: register special custom admin title columns
...
function slb_add_subscription( $subscriber_id, $list_id  ) {
    ...
    if ( !slb_subscriber_has_subscription( $subscriber_id, $list_id ) ):
        ...
        array_push( $subscriptions, $list_id ); // $subscriptions[]=$list_id would do the same thing

        // update_slb_subscriptions
...
function slb_subscriber_has_subscription( $subscriber_id, $list_id ) {
    ...
    if( in_array($list_id, $subscriptions) ):
        ...
        // this scubscriber is not yet subscribed to this list
...
// 6.5
// hint: gets the unique acf field key from the field name
function slb_get_acf_key( $field_name ) {
    ...
    switch( $field_name ) {
        ...
        case 'slb_fname':
            $field_key = 'field_5b325f56a3490';
            break;
        case 'slb_lname':
            $field_key = 'field_5b325f92a3491';
            break;
        case 'slb_email':
            $field_key = 'field_5b325fbda3492';
            break;
        case 'slb_subscriptions':
            $field_key = 'field_5b326001a3493';
            break;
    }
...
function slb_options_admin_page() {
	...
	echo('<div class="wrap">
        ...
        // outputs a unique nounce for our plugins options
